...
class Carrito extends React.Component{
          ...
          <div className="container">
            ...
            <div className="animated fadeIn slow">
              <div className="box carrito">
                <div className="row col s12 green darken-1 animated fadeInDown fast">
  ...
  pagarCarrito(){
    ...
    request
    .get('https://tienda-angular-2.firebaseio.com/productos/.json')                //Realizar una consulta a la base de datos
    .then((res) => {
...
actualizarDB(itemCatalogo, cantidad){
  request.put(`https://tienda-angular-2.firebaseio.com/productos/${itemCatalogo.id}.json`)  //Realizar consulta a base de datos
